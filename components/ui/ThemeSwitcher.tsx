...
export default function ThemeSwitcher() {
  ...
  return (
    <div className="fixed bottom-4 left-0 right-0 z-50 animate-slide-up pointer-events-none pb-[env(safe-area-inset-bottom)] px-4 flex justify-center">
      <div className="pointer-events-auto bg-white/95 backdrop-blur-sm rounded-full shadow-soft-lg px-2 py-2 flex items-center gap-1 border border-theme-border max-w-full overflow-x-auto">
        {/* Theme label */}
